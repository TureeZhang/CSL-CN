export class HomepageSettingsDto {
  ...
  public websiteRecordNumber: string;
  ...
  public boardTitleC: string;
  public boardTitleD: string;
  public boardTitleE: string;
  public boardTitleF: string;

  public boardContentB: string;
  ...
  public outsideMediaLinkText: string;
  public outsideMediaLinkUrl: string;
}
