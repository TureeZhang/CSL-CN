...
var AdminHomepageComponent = /** @class */ (function () {
    ...
    AdminHomepageComponent.prototype.init = function () {
        this.data.push(new admin_homepage_card_1.AdminHomepageCard("/admin/userinfoes", "userinfoAvatarTemplate", "用户", "查看并管理注册用户信息", "user"), new admin_homepage_card_1.AdminHomepageCard("/admin/donators", "donatorRankTemplate", "捐赠", "查看并管理捐赠者统计数据", "heart"), new admin_homepage_card_1.AdminHomepageCard("/admin/wikipassages", "wikiPassageTemplate", "文章", "查看并管理维基文档", "file-text"), new admin_homepage_card_1.AdminHomepageCard("/admin/storagefiles", "cloudFileTemplate", "文件", "查看并管理已上传文件", "cloud-upload"), new admin_homepage_card_1.AdminHomepageCard("/admin/homepagesettings", "homepageSettingsTemplate", "首页设置", "查看并编辑系统关键信息", "desktop"));
    };
