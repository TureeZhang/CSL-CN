(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngx-markdown-editor', ['exports', '@angular/common', '@angular/forms', '@angular/platform-browser', '@angular/core'], factory) :
    (factory((global['ngx-markdown-editor'] = {}),global.ng.common,global.ng.forms,global.ng.platformBrowser,global.ng.core));
}(this, (function (exports,common,forms,platformBrowser,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MarkdownEditorResizeSensorComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MarkdownEditorResizeSensorComponent.ctorParameters = function () {
            return [
                { type: core.NgZone }
            ];
        };
        MarkdownEditorResizeSensorComponent.propDecorators = {
            resizeSensor: [{ type: core.ViewChild, args: ['resizeSensor',] }],
